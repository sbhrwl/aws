...
AllowedMethods: GET		
AllowedOrigins: <Origin that wants to access our website>
```
## 4. Consistency Model		
...
## 6. What is the correct indication that an object was successfully stored when you put objects in Amazon S3?
...
```
  ...
  - Choose from your master keys (Customer can have its on keys)		
  - KMS master key ARN (from another account)		
## 3. SSE-C		
...
## 7. KMS with CloudHSM
- KMS with CloudHSM => Full Control		
...
## 6. How to Restrict third parties from directly accessing the S3 content in the bucket: Use BUCKET POLICY with condition aws:referer key
...
## 7. Use IAM policy to grant programmatic access or AWS Management Console access to AWS resources (S3 etc)		
<img src="images/3.png">

## 8. How to allow access to S3 bucket to AWS resource (EC2)											
...
### Question
- There was a new batch of updated images that were uploaded in S3, however, the users were reporting that they were still seeing the old content. 
